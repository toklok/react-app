            ...
            <section className="col-lg-12 main-dashboard">
                <section className="col-lg-12">
                    <section className="panel panel-default">
                        <section className="main-panel_heading"><span
                            className="main-dashboard_span">Opportunities</span> { `${this.props.title}` }</section>
                        <section className="panel-body">
                            <section className="col-lg-9">
                                ...
                                <section className="dashboard-notifications_alert">
                                    <p>Store <a href="#">Boston(130)</a> was found with High Damage Registration for
                                        High Risk Products in the last 7 days compare to previous 14 days and compare to
                                        North region bench mark activity.</p>
                                </section>
                            </section>
                            <section className="dashboard-rightSide_wrapper">
                                <section className="col-lg-12 dashboard-rightSide_container">
                                ...
                                <section className="col-lg-12 dashboard-rightSide_container">
                                    <section className="main-dashboard_panel-blue">
                                        <section className="main-dashboard_title">
                            ...
                            <section className="col-lg-9 dashboard-input">
                                ...
                                <button onClick={
                                    () => {
                                        ...
                                        (this.refs.commentField.value !== '') ? this.onSubmit(this.refs.commentField.value) : alert('Error: You can\'t add an empty string!');
